...
const T = {
  // NAV
  nav_about:   { ko:'소개', en:'About', zh:'关于', ja:'概要', fr:'À propos', de:'Über uns', es:'Acerca' },
  nav_event:   { ko:'행사', en:'Event', zh:'活动', ja:'イベント', fr:'Événement', de:'Veranstaltung', es:'Evento' },
  nav_roadmap: { ko:'로드맵', en:'Roadmap', zh:'路线图', ja:'ロードマップ', fr:'Feuille de route', de:'Fahrplan', es:'Hoja de ruta' },
  nav_founder: { ko:'설립자', en:'Founder', zh:'创始人', ja:'創設者', fr:'Fondateur', de:'Gründer', es:'Fundador' },
  nav_cta:     { ko:'참가 신청', en:'Register', zh:'报名参加', ja:'参加申込', fr:'S\'inscrire', de:'Anmelden', es:'Registrarse' },
  ...
  hero_tagline1:{ ko:'전기자동차 시대,', en:'The Age of Electric Vehicles,', zh:'电动汽车时代，', ja:'電気自動車の時代、', fr:'À l\'ère des véhicules électriques,', de:'Das Zeitalter der Elektrofahrzeuge,', es:'La era de los vehículos eléctricos,' },
  hero_tagline2:{ ko:'한국이 만드는 글로벌 축제', en:'Korea\'s Global Festival', zh:'韩国打造的全球盛典', ja:'韓国が作るグローバルフェスティバル', fr:'Le Festival Mondial Créé par la Corée', de:'Koreas Globales Festival', es:'El Festival Global Creado por Corea' },
  stat1_lbl:    { ko:'대 기네스 도전', en:'Cars for Guinness', zh:'辆吉尼斯挑战', ja:'台ギネス挑戦', fr:'Voitures pour Guinness', de:'Autos für Guinness', es:'Autos para Guinness' },
  stat2_lbl:    { ko:'개국 국기 래핑', en:'Nations\' Flags', zh:'个国家国旗', ja:'カ国旗', fr:'Drapeaux Nationaux', de:'Nationalflaggen', es:'Banderas Nacionales' },
  stat3_lbl:    { ko:'파일럿 목표', en:'Pilot Target', zh:'试行目标', ja:'パイロット目標', fr:'Objectif Pilote', de:'Pilotprojektziel', es:'Meta Piloto' },
  btn_learn:    { ko:'행사 알아보기', en:'Learn More', zh:'了解更多', ja:'詳しく見る', fr:'En savoir plus', de:'Mehr erfahren', es:'Saber más' },
  btn_register: { ko:'참가 신청하기', en:'Register Now', zh:'立即报名', ja:'今すぐ申込', fr:'S\'inscrire', de:'Jetzt anmelden', es:'Inscríbete ya' },

  // ABOUT
  about_label:  { ko:'ABOUT EMC', en:'ABOUT EMC', zh:'关于EMC', ja:'EMCについて', fr:'À PROPOS D\'EMC', de:'ÜBER EMC', es:'SOBRE EMC' },
  about_title:  { ko:'왜 EMC인가?', en:'Why EMC?', zh:'为什么选择EMC？', ja:'なぜEMCなのか？', fr:'Pourquoi EMC ?', de:'Warum EMC?', es:'¿Por qué EMC?' },
  ...
  card1_title:  { ko:'전기차 시대의 도래', en:'Dawn of the EV Era', zh:'电动汽车时代的到来', ja:'EV時代の到来', fr:'L\'ère des VE', de:'Das EV-Zeitalter', es:'La Era del VE' },
  ...
  card2_title:  { ko:'F1이 준 영감', en:'Inspired by F1', zh:'F1带来的灵感', ja:'F1からのインスピレーション', fr:'Inspiré par la F1', de:'Von der F1 Inspiriert', es:'Inspirado en la F1' },
  ...
  card3_title:  { ko:'한국만이 할 수 있는 것', en:'Only Korea Can Do This', zh:'只有韩国能做到', ja:'韓国だけができること', fr:'Seulement la Corée Peut', de:'Nur Korea Kann Das', es:'Solo Corea Puede Hacerlo' },
  ...
  card4_title:  { ko:'E = mc² 철학', en:'E = mc² Philosophy', zh:'E = mc²哲学', ja:'E = mc²の哲学', fr:'Philosophie E = mc²', de:'E = mc² Philosophie', es:'Filosofía E = mc²' },
  ...
  // EVENT
  event_label:  { ko:'FLAGSHIP EVENT', en:'FLAGSHIP EVENT', zh:'旗舰活动', ja:'フラッグシップイベント', fr:'ÉVÉNEMENT PHARE', de:'HAUPTVERANSTALTUNG', es:'EVENTO PRINCIPAL' },
  event_title:  { ko:'기네스 도전 국제 전기차 페스티벌', en:'Guinness Record EV Festival', zh:'吉尼斯挑战国际电动车节', ja:'ギネス挑戦国際EVフェスティバル', fr:'Festival EV Défi Guinness', de:'Guinness-Rekord EV Festival', es:'Festival Internacional EV Récord Guinness' },
  ...
  route1_title: { ko:'인천 출발', en:'Incheon Departure', zh:'仁川出发', ja:'仁川出発', fr:'Départ Incheon', de:'Abfahrt Incheon', es:'Salida Incheon' },
  ...
  route2_title: { ko:'서울 한강', en:'Seoul Han River', zh:'首尔汉江', ja:'ソウル漢江', fr:'Han-Gang Séoul', de:'Seoul Han-Fluss', es:'Río Han, Seúl' },
  ...
  route3_title: { ko:'파주 도착', en:'Paju Arrival', zh:'坡州到达', ja:'坡州到着', fr:'Arrivée à Paju', de:'Ankunft Paju', es:'Llegada a Paju' },
  ...
  guinness_note:{ ko:'전세계 200개국 국기를 래핑한 전기차들이 한국의 평화 루트를 달립니다', en:'Electric vehicles wrapped in 200 national flags drive Korea\'s peace route', zh:'贴有200个国家国旗的电动车行驶在韩国的和平路线上', ja:'200カ国の国旗をラッピングした電気自動車が韓国の平和ルートを走ります', fr:'Des voitures électriques décorées des drapeaux de 200 nations parcourent la route de la paix en Corée', de:'Mit 200 Nationalflaggen gewrappte Elektrofahrzeuge fahren Koreas Friedensroute', es:'Vehículos eléctricos con banderas de 200 naciones recorren la ruta de paz de Corea' },
  dk_record:    { ko:'2016년 덴마크 기록', en:'2016 Denmark Record', zh:'2016年丹麦记录', ja:'2016年デンマーク記録', fr:'Record Danemark 2016', de:'Dänemark-Rekord 2016', es:'Récord Dinamarca 2016' },
  emc_target:   { ko:'EMC 목표 — 세계신기록', en:'EMC Target — World Record', zh:'EMC目标 — 世界新纪录', ja:'EMC目標 — 世界新記録', fr:'Objectif EMC — Nouveau Record', de:'EMC-Ziel — Weltrekord', es:'Meta EMC — Récord Mundial' },

  // ROADMAP
  rm_label:     { ko:'ROADMAP', en:'ROADMAP', zh:'路线图', ja:'ロードマップ', fr:'FEUILLE DE ROUTE', de:'FAHRPLAN', es:'HOJA DE RUTA' },
  rm_title:     { ko:'단계별 추진 계획', en:'Step-by-Step Plan', zh:'分阶段推进计划', ja:'段階的推進計画', fr:'Plan par Étapes', de:'Stufenweiser Plan', es:'Plan por Etapas' },

  phase1_title: { ko:'기반 구축', en:'Foundation', zh:'基础建设', ja:'基盤構築', fr:'Fondation', de:'Grundlagenaufbau', es:'Fundación' },
  ...
  phase2_title: { ko:'파일럿 행사', en:'Pilot Event', zh:'试行活动', ja:'パイロットイベント', fr:'Événement Pilote', de:'Pilotveranstaltung', es:'Evento Piloto' },
  ...
  phase3_title: { ko:'공식 1회 대회 🏆', en:'Official 1st Event 🏆', zh:'第一届正式赛事 🏆', ja:'公式第1回大会 🏆', fr:'1ère Édition Officielle 🏆', de:'Offizielle 1. Veranstaltung 🏆', es:'1er Evento Oficial 🏆' },
  ...
  phase4_title: { ko:'글로벌 IP화', en:'Global IP Expansion', zh:'全球IP化', ja:'グローバルIP化', fr:'Expansion IP Mondiale', de:'Globale IP-Expansion', es:'Expansión IP Global' },
  ...
  // WHY KOREA
  why_label:    { ko:'WHY KOREA', en:'WHY KOREA', zh:'为什么是韩国', ja:'なぜ韓国', fr:'POURQUOI LA CORÉE', de:'WARUM KOREA', es:'POR QUÉ COREA' },
  why_title:    { ko:'한국이어야 하는 이유', en:'Why Korea', zh:'为什么是韩国', ja:'韓国である理由', fr:'Pourquoi la Corée', de:'Warum Korea', es:'Por qué Corea' },
  ...
  // FOUNDER
  founder_label:{ ko:'FOUNDER', en:'FOUNDER', zh:'创始人', ja:'創設者', fr:'FONDATEUR', de:'GRÜNDER', es:'FUNDADOR' },
  founder_title:{ ko:'설립자', en:'Founder', zh:'创始人', ja:'設立者', fr:'Fondateur', de:'Gründer', es:'Fundador' },
  founder_role: { ko:'Founder & Chairman, EMC International', en:'Founder & Chairman, EMC International', zh:'创始人兼主席，EMC国际', ja:'創設者・会長、EMCインターナショナル', fr:'Fondateur et Président, EMC International', de:'Gründer & Vorsitzender, EMC International', es:'Fundador y Presidente, EMC International' },
  cred1:        { ko:'Harvard University, Economics', en:'Harvard University, Economics', zh:'哈佛大学，经济学', ja:'ハーバード大学、経済学', fr:'Harvard University, Économie', de:'Harvard University, Wirtschaftswissenschaften', es:'Universidad Harvard, Economía' },
  cred2:        { ko:'21권의 저서', en:'Author of 21 Books', zh:'21本著作', ja:'21冊の著書', fr:'Auteur de 21 livres', de:'Autor von 21 Büchern', es:'Autor de 21 libros' },
  cred3:        { ko:'미국 국적 · 글로벌 네트워크', en:'US Citizen · Global Network', zh:'美国国籍·全球网络', ja:'米国籍・グローバルネットワーク', fr:'Citoyen américain · Réseau mondial', de:'US-Staatsbürger · Globales Netzwerk', es:'Ciudadano estadounidense · Red global' },
  cred4:        { ko:'2020년부터 EMC 아이디어 구상', en:'EMC concept since 2020', zh:'2020年起构思EMC理念', ja:'2020年からEMCアイデア構想', fr:'Concept EMC depuis 2020', de:'EMC-Konzept seit 2020', es:'Concepto EMC desde 2020' },
  ...
  // CONTACT
  contact_label:{ ko:'JOIN US', en:'JOIN US', zh:'加入我们', ja:'参加する', fr:'REJOIGNEZ-NOUS', de:'MITMACHEN', es:'ÚNETE' },
  contact_title:{ ko:'함께 만들어 가세요', en:'Build It With Us', zh:'一起共建', ja:'一緒に作りましょう', fr:'Construisons Ensemble', de:'Gemeinsam Aufbauen', es:'Construyámoslo Juntos' },
  ...
  ct1_title:    { ko:'스폰서십', en:'Sponsorship', zh:'赞助', ja:'スポンサーシップ', fr:'Parrainage', de:'Sponsoring', es:'Patrocinio' },
  ...
  ct2_title:    { ko:'참가 신청', en:'Registration', zh:'报名参加', ja:'参加申込', fr:'Inscription', de:'Anmeldung', es:'Registro' },
  ...
  ct3_title:    { ko:'미디어 협력', en:'Media Partnership', zh:'媒体合作', ja:'メディア協力', fr:'Partenariat Médias', de:'Medienpartnerschaft', es:'Asociación de Medios' },
  ...
  ct4_title:    { ko:'기관 협력', en:'Institutional Partnership', zh:'机构合作', ja:'機関協力', fr:'Partenariat Institutionnel', de:'Institutionelle Partnerschaft', es:'Asociación Institucional' },
  ...
  form_name:    { ko:'성함', en:'Name', zh:'姓名', ja:'お名前', fr:'Nom', de:'Name', es:'Nombre' },
  form_email:   { ko:'이메일', en:'Email', zh:'电子邮件', ja:'メール', fr:'E-mail', de:'E-Mail', es:'Correo' },
  form_select:  { ko:'문의 유형 선택', en:'Select inquiry type', zh:'选择咨询类型', ja:'お問い合わせの種類', fr:'Type de demande', de:'Anfragetyp wählen', es:'Tipo de consulta' },
  form_msg:     { ko:'메시지를 입력해주세요', en:'Enter your message', zh:'请输入您的留言', ja:'メッセージを入力してください', fr:'Votre message', de:'Ihre Nachricht', es:'Su mensaje' },
  form_submit:  { ko:'문의하기 →', en:'Send Message →', zh:'发送消息 →', ja:'送信する →', fr:'Envoyer →', de:'Senden →', es:'Enviar →' },
  form_done:    { ko:'전송 완료! ✓', en:'Sent! ✓', zh:'已发送！✓', ja:'送信完了！✓', fr:'Envoyé ! ✓', de:'Gesendet! ✓', es:'¡Enviado! ✓' },
